...
export const Categories = [
  {
    ...
    img: categories[0],
    subCategories: [
      { name: 'BASBOUSA', slug: 'BASBOUSA' },
      { name: 'BAKLAVA', slug: 'BAKLAVA' },
      { name: 'KONAFA', slug: 'KONAFA' },
      { name: 'GOULASH', slug: 'GOULASH' },
      { name: 'SYRIAN', slug: 'SYRIAN' },
    ],
  },
  {
    name: 'Clothes',
    ...
    subCategories: [
      ...
      { name: 'KHAK & PETIT FOUR', slug: 'KHAK&PETIT-FOUR' },
    ],
  },
  {
    name: 'Shoes',
    ...
    subCategories: [
      ...
      { name: 'CHICKEN PLATES', slug: 'CHICKEN-PLATES' },
      { name: 'FATTAH', slug: 'FATTAH' },
      { name: 'PASTA DISHES', slug: 'PASTA-DISHES' },
      { name: 'RICE PLATES', slug: 'RICE-PLATES' },
      { name: 'SEA FOOD', slug: 'SEA-FOOD' },
      { name: 'SIDE DISHES', slug: 'SIDE-DISHES' },
      { name: 'SOUPS', slug: 'SOUPS' },
      { name: 'TAJINS', slug: 'TAJINS' },
      { name: 'MEAT BLATES', slug: 'MEAT-BLATES' },
    ],
  },
  {
    name: 'uncategories',
  ...
  },
  {
    ...
    img: categories[4],
    subCategories: [
      { name: 'om ali', slug: 'om-ali' },
      { name: 'cream cramel', slug: 'cream-cramel' },
    ],
  },
  {
    name: 'Packages',
